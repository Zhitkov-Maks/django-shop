...
class Order(models.Model):
    ...
    type_payment = models.CharField(
        verbose_name="Тип платежа", choices=TYPE_PAYMENT, max_length=10, default="cart"
    )
    ...
    total_price = models.DecimalField(
        verbose_name="Общая стоимость", decimal_places=2, max_digits=8, default=0
    )
    status = models.ForeignKey(
        Status, verbose_name="Статус", related_name="statuses", on_delete=models.CASCADE
    )
